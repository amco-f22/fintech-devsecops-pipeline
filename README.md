...
│         │            └──────┬───────┘           │                   │
│         │                   │                   │                   │
│    Stops if fail       Stops if fail       Only on main            │
│                                                 │                   │
│                                                 ▼                   │
│                                          ┌──────────────┐           │
│                                          │  ArgoCD      │           │
...
│  │    └──────────────────────────────────────┘           │            │
│  │                                                      │            │
│  │  VPC Endpoints: ECR, S3, STS (no internet transit)   │            │
│  │  VPC Flow Logs → CloudWatch (audit trail)            │            │
│  └─────────────────────────────────────────────────────┘            │
│                                                                      │
│  KMS Encryption: Secrets at rest │ ECR Images │ EBS Volumes         │
└─────────────────────────────────────────────────────────────────────┘
```
